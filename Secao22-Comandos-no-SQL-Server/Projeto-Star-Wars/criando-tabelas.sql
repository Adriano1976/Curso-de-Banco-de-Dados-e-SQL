...
ALTER TABLE Pilotos 
ADD CONSTRAINT FK_Pilotos_Planetas 
...
ALTER TABLE PilotosNaves
ADD CONSTRAINT PK_PilotosNaves 
...
ALTER TABLE PilotosNaves ADD CONSTRAINT DF_PilotosNaves_FlaugAutorizado
DEFAULT (1) FOR FlagAutorizado 
GO  

-- Criando tabela Histórico de Viagens ----------------------------------------
...
ALTER TABLE HistoricoViagens ADD CONSTRAINT FK_HistoricoViagens_PilotosNaves
