...
insert into funcionario values (5,'Ellis','jellis4@sciencedirect.com','Feminino','Alimentícios',63702,'Software Engineer III',7);
...
insert into funcionario values (13,'Schmidt','sschmidtc@state.gov','Masculino','Bebês',85227,'Compensation Analyst',3);
...
insert into funcionario values (16,'Medina','smedinaf@amazonaws.com','Feminino','Bebês',106659,'Web Developer III',1);
insert into funcionario values (17,'Morgan','dmorgang@123-reg.co.uk','Feminino','Crianças',148952,'Programmer IV',6);
