...
create table colaboradores(
  ...
  cargo varchar2(40),
  id_Regiao int,
  constraint fk_colaborador_regiao 
  foreign key (id_Regiao) references regioes
);
...
-- CONSULTANDO OS REGISTROS RECEM INSERIDOS -----------------------------------
...
select constraint_name, deferrable as "ATRASADA", deferred as "VEFIFICADA"
from user_constraints 
where table_name in('COLABORADORES', 'TELEPHONES', 'REGIOES'); 
